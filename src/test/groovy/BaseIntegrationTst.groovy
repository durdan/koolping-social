import com.koolping.rest.util.DateUtil
...
abstract class BaseIntegrationTst extends GroovyTestCase {
    ...
    protected static final String DATE_STRING = DateUtil.currentDateAsIso8061String;

    private static final BASE_URL = "http://localhost:" + System.getProperty("tomcatPort", "8080") + "/koolping-social/";
